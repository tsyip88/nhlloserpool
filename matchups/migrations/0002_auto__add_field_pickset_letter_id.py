...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PickSet.letter_id'
        db.add_column(u'matchups_pickset', 'letter_id',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length='32'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PickSet.letter_id'
        db.delete_column(u'matchups_pickset', 'letter_id')
    ...
    models = {
        ...
        u'matchups.pickset': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'letter_id': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': "'32'"}),
